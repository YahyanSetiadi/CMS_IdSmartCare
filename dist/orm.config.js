...
exports.config = {
    ...
    entities: [bisnis_owner_entity_1.BisnisOwner, fasyankes_entity_1.Fasyankes, bo_infos_entity_1.BoInfos, legal_dokumen_entity_1.LegalDokumen, access_console_entity_1.AccessConsole, access_fasyankes_entity_1.AccessFasyankes],
    synchronize: false,
    logging: true,
